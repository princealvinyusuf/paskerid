    ...
    public function run()
    {
        DB::table('information')->insert([
            [
                ...
                'file_url' => null,
                'iframe_url' => 'https://example.com/iframe1',
            ...
            [
                ...
                'iframe_url' => 'https://example.com/iframe2',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'file_url' => null,
                'iframe_url' => 'https://example.com/iframe3',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'iframe_url' => 'https://example.com/iframe4',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'subject' => 'Subjek 3',
                'file_url' => null,
                'iframe_url' => 'https://example.com/iframe5',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'iframe_url' => 'https://example.com/iframe6',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
        ]);
