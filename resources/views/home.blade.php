    ...
    <section class="stat-carousel-section position-relative" style="z-index: 10;">
        <div class="container-fluid position-relative px-2 px-sm-3">
            ...
            <div class="d-flex align-items-center position-relative mb-4">
                ...
                <div id="statScrollRow" class="d-flex px-0" style="scroll-behavior:smooth; gap:16px; width:100%; overflow-x:hidden;">
            ...
            <div class="d-flex align-items-center position-relative">
                ...
                <div id="highlightStatScrollRow" class="d-flex px-0" style="scroll-behavior:smooth; gap:16px; width:100%; overflow-x:hidden;">
