    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top shadow-sm">
        <div class="container-fluid d-flex flex-row justify-content-between align-items-center px-0">
            ...
            <div class="d-flex align-items-center me-0 pe-2">
                ...
                <img src="{{ asset('images/indonesia_merdeka.png') }}" alt="Indonesia Merdeka: Bersatu Berdaulat, Rakyat Sejahtera, Indonesia Maju" class="ms-2" style="height:40px; width:auto;">
