                ...
                <ul class="navbar-nav ms-auto gap-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="monitoringDropdown">
                            ...
                            <li><a class="dropdown-item @if(request()->routeIs('dashboard.distribution')) active fw-bold @endif" href="{{ route('dashboard.distribution') }}">Dashboard Tren Pencari Kerja</a></li>
